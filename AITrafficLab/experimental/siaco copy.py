...
class Sonic_edge_generator(generators.Edge_generator): 
    ...
    def __init__(self, connection, speed_coef, lane_coef, len_coef, src_central_coef, dst_central_coef, edge_observables = {}, edge_class = agents.Road_agent, max_speed = 33.33, max_lanes = 4, max_length = 3000, epsilon = 0.2):
